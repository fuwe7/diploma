...
# 1. Загрузка данных
# =========================
df = pd.read_csv("data/processed_dataTEST30lag.csv")
df['date'] = pd.to_datetime(df['date'])

# =========================
# 2. Признаки и целевая переменная
# =========================
features = [f'lag_{i}' for i in range(1, 31)]
...
results_df.to_csv("results/rf_forecastTEST30lag.csv", index=False)
print("Прогноз сохранён в results/rf_forecastTEST30lag.csv")
...
plt.tight_layout()
plt.savefig("plots/rf_forecastTEST30lag.png", dpi=300)
plt.show()